// AprovarAgendamentoUseCase.java
...
public class AprovarAgendamentoUseCase {
  ...
  public PedidoCirurgico execute(String pedidoId, String usuario, String observacao) {
    ...
    pedido.aprovarAgendamento(usuario, observacao);
